...
@implementation CXPlayerToolView
...
- (void)createTopView
{
    _topView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, self.width, MC_NavHeight)];
    _topView.backgroundColor = [UIColor clearColor];
    
    _backBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, MC_StatusBarHeight, 44, 44)];
...
{
    _bottomView = [[UIView alloc]initWithFrame:CGRectMake(0, self.height - kToolViewHeight-MC_TabbarSafeBottomMargin, self.width, kToolViewHeight)];
...
- (void)layoutSubviews
{
    ...
    _topView.frame = CGRectMake(0, 0, self.width, MC_NavHeight);
    _backBtn.frame = CGRectMake(0, MC_StatusBarHeight, 44, 44);
    
    
    _bottomView.frame = CGRectMake(0, self.height - kToolViewHeight - MC_TabbarSafeBottomMargin, self.width, kToolViewHeight);
...
{
    //拿到图片资源
    NSBundle * imgBundle = [NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"CXXHMoviePlayer" ofType:@"bundle"]];
